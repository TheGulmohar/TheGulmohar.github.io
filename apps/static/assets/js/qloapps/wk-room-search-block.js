...
*/
let adults_txt="Adults"
let room_txt="Room"
let min_child_in_room=0
let max_child_in_room=3
var select_age_txt = "Select Age";
var under_1_age = "Under 1 Year";
var max_child_age=10
var adult_txt="Adult"
var child_txt="Child"
var max_children_txt="Max Children"
...
$(document).ready(function() {
    ...
    function createDateRangePicker(max_order_date, preparation_time, dateFrom, dateTo)
    {
        ...
        console.log("('#daterange_value').data('daterangepicker')")
        console.log($('#daterange_value').data('daterangepicker'))
        console.log($('#daterange_value').data('daterangepicker'))
        if (dateFrom && dateTo) {
    $('#daterange_value').datepicker('option', 'minDate', dateFrom);
    $('#daterange_value').datepicker('option', 'maxDate', dateTo);
}
        // if (dateFrom && dateTo) {
    ...
    $(document).on('click', '.hotel_dropdown_ul li', function() {
        ...
        console.log("those times:", $('#check_in_time').val(), $('#check_out_time').val())
    ...
    $(document).ready(function() {
        $('#daterange_value').daterangepicker({
            // your daterangepicker options here
        });
    
        $('#daterange_value').on('apply.daterangepicker', function(ev, picker) {
            $(this).find('span').text(picker.startDate.format('MM/DD/YYYY') + ' - ' + picker.endDate.format('MM/DD/YYYY'));
            $(this).find('input[name="daterange"]').val(picker.startDate.format('MM/DD/YYYY') + ' - ' + picker.endDate.format('MM/DD/YYYY'));
        });
    });
