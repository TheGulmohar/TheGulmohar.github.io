...
ALLOWED_HOSTS        = ['gulmohar.azurewebsites.net',"gulmohar.live", "127.0.0.1", "www.gulmohar.live"]
...
if os.environ.get('DB_ENGINE') and os.environ.get('DB_ENGINE') == "django.db.backends.postgresql":
    DATABASES = { 
      'default': {
